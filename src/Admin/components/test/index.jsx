            ...
            <div className="sidebar-inner slimscroll">
                <div id="sidebar-menu" className="sidebar-menu">
                    <ul>
                        ...
                        <li> 
                            <Link to="/admin/booking-list"><i className="fe fe-layout"></i> <span>Appointments</span></Link>
                        </li>
                        <li> 
                        ...
                        <li className="submenu">
                            <Link href="#"><i className="fe fe-document"></i> <span> Reports</span> <span className="menu-arrow"></span></Link>
                            <ul>
                                <li><Link to="/admin/invoice-list">Invoices List</Link></li>
                            </ul>
                        </li>
                        <li className="menu-title"> 
                            <span>Pages</span>
                        ...
                        <li className="submenu">
                            <Link href="#"><i className="fe fe-document"></i> <span> Authentication </span> <span className="menu-arrow"></span></Link>
                            <ul>
                        ...
                        <li className="submenu">
                            <Link href="#"><i className="fe fe-warning"></i> <span> Error Pages </span> <span className="menu-arrow"></span></Link>
                            <ul>
                        ...
                        <li className="submenu">
                            <Link href="#"><i className="fe fe-layout"></i> <span> Forms </span> <span className="menu-arrow"></span></Link>
                            <ul >
                        ...
                        <li className="submenu">
                            <Link href="#"><i className="fe fe-table"></i> <span> Tables </span> <span className="menu-arrow"></span></Link>
                            <ul >
                        ...
                        <li className="submenu">
                            <Link href="#0"><i className="fe fe-code"></i> <span>Multi Level</span> <span className="menu-arrow"></span></Link>
                            <ul >
                                <li className="submenu">
                                    <Link href="#0"> <span>Level 1</span> <span className="menu-arrow"></span></Link>
                                    <ul >
                                        <li><Link href="#0"><span>Level 2</span></Link></li>
                                        <li className="submenu">
                                            <Link href="#0"> <span> Level 2</span> <span className="menu-arrow"></span></Link>
                                            <ul >
                                                <li><Link href="#0">Level 3</Link></li>
                                                <li><Link href="#0">Level 3</Link></li>
                                            </ul>
                                        </li>
                                        <li><Link href="#0"> <span>Level 2</span></Link></li>
                                ...
                                <li>
                                    <Link href="#0"> <span>Level 1</span></Link>
                                </li>
                            </ul>
                        </li>
                    </ul>
