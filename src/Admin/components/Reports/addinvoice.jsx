...
import {
  invoicecircle1, invoicecircle2, logo, signature
} from "../imagepath";
...
const AddInvoice = () => {
  ...
  useEffect(() => {
    setCurrentDate(new Date()); // Cleanup interval on component unmount
  }, []);
  ...
  return (
    <>
      ...
      <SidebarNav />
        ...
        {/* Page Wrapper */}
        <div className="page-wrapper invoice-wrapper">
                          ...
                          <div className="row">
                            ...
                            <div className="col-lg-4 col-md-12">
                              <div className="invoice-info invoice-info-one border-0">
                                <p>Issue Date : 27 Jul 2024</p>
                                <p>Due Date : 27 Aug 2024</p>
