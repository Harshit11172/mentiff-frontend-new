...
import { blog01,avatar10 } from "../imagepath";
                  ...
                  <div className="row">
                    <div className="col-12 blog-details">
                      ...
                      <div className="d-flex flex-wrap date-col">
                        <span className="date">
                          <i className="fas fa-calendar-check" /> April 09 2020
                        </span>
                        <span className="author">
                          <i className="fe fe-user" /> By Andrew Dawis
                        </span>
                      </div>
                      ...
                      <div className="blog-content">
                        ...
                        <blockquote>
                          ...
                          posuere consectetur est at lobortis. Aenean eu leo
