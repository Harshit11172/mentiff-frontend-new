        ...
        <div className="doctor-filter-inner">
          ...
          <div className="doctor-filter-option">
            ...
            <div className="doctor-filter-sort">
              <ul className="nav">
                <li>
                  <Link to="/mentee/map-list" id="map-list">
                    <FiMapPin />
                  </Link>
                </li>
                <li>
                  <Link to="/mentee/map-grid">
                    <FiGrid />
                  </Link>
                </li>
                <li>
                  <Link to="/mentee/map-list" className="active">
                    <FiList />
                  </Link>
                </li>
              </ul>
          ...
          <div className="doctor-widget-one">
            <div className="doc-info-left">
              <div className="doctor-img">
                <Link to="/mentee/map-list">
                  <img src={doctor_13} className="img-fluid" alt="" />
                </Link>
                <div className="favourite-btn">
                  <Link to="/mentee/map-list" className="favourite-icon">
                    <FiHeart />
                  </Link>
                </div>
              </div>
              <div className="doc-info-cont">
                <h4 className="doc-name">
                  <Link to="/mentee/mentor-profile">John Doe</Link>
            ...
            <div className="doc-info-right">
              ...
              <div className="clinic-booking book-appoint">
                <Link className="btn btn-primary" to="/mentee/booking1">
                  Book Appointment
                </Link>
                <Link className="btn btn-primary-light" to="/mentee/booking2">
        ...
        <div className="card-body">
          <div className="doctor-widget-one">
            <div className="doc-info-left">
              ...
              <div className="doc-info-cont">
                <h4 className="doc-name">
                  <Link to="/mentee/mentor-profile">Darren Elder</Link>
                  <i className="fas fa-circle-check" />
                </h4>
        ...
        <div className="card-body">
          <div className="doctor-widget-one">
            <div className="doc-info-left">
              ...
              <div className="doc-info-cont">
                <h4 className="doc-name">
                  <Link to="/mentee/mentor-profile">Sofia Brient</Link>
                  <i className="fas fa-circle-check" />
                </h4>
                <p className="doc-speciality">MBBS, Dentist</p>
                <div className="clinic-details">
        ...
        <div className="card-body">
          <div className="doctor-widget-one">
            <div className="doc-info-left">
              ...
              <div className="doc-info-cont">
                <h4 className="doc-name">
                  <Link to="/mentee/mentor-profile">Johny Rita</Link>
                  <i className="fas fa-circle-check" />
                </h4>
                <p className="doc-speciality">MBBS, Dentist</p>
                <div className="clinic-details">
        ...
        <div className="card-body">
          <div className="doctor-widget-one">
            <div className="doc-info-left">
              ...
              <div className="doc-info-cont">
                <h4 className="doc-name">
                  <Link to="/mentee/mentor-profile">Deborah Angel</Link>
                  <i className="fas fa-circle-check" />
                </h4>
                <p className="doc-speciality">MBBS, Dentist</p>
                <div className="clinic-details">
