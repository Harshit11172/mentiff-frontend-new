...
import IMG01 from "../../../assets/images/user/user2.jpg";
...
const Booking = (props) => {
  ...
  const { mentorData } = props.location.state || {};
            ...
            <div className="col-12">
              ...
              <div className="row">
                <div className="col-12 col-sm-4 col-md-6">
                  <h4 className="mb-1">11 November 2024</h4>
                        ...
                        <ul>
                          ...
                          <li>
                            ...
                            <span className="slot-date">
                              11 Nov <small className="slot-year">2024</small>
                            </span>
                          </li>
                          <li>
                            <span>Tue</span>
                            <span className="slot-date">
                              12 Nov <small className="slot-year">2024</small>
                            </span>
                          </li>
                          <li>
                            <span>Wed</span>
                            <span className="slot-date">
                              13 Nov <small className="slot-year">2024</small>
                            </span>
                          </li>
                          <li>
                            <span>Thu</span>
                            <span className="slot-date">
                              14 Nov <small className="slot-year">2024</small>
                            </span>
                          </li>
                          <li>
                            <span>Fri</span>
                            <span className="slot-date">
                              15 Nov <small className="slot-year">2024</small>
                            </span>
                          </li>
                          <li>
                            <span>Sat</span>
                            <span className="slot-date">
                              16 Nov <small className="slot-year">2024</small>
                            </span>
                          </li>
                          <li>
                            <span>Sun</span>
                            <span className="slot-date">
                              17 Nov <small className="slot-year">2024</small>
                            </span>
                          </li>
