            ...
            <ul className="main-nav">
              ...
              <li className="has-submenu">
                ...
                <ul className="submenu">
                  <li>
                    <Link to="/mentor/mentor-dashboard">Doctor Dashboard</Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to="/mentor/mentee-list">Patients List</Link>
                  </li>
                  <li>
                    <Link to="/mentor/mentee-profile">Patients Profile</Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to="/mentor/mentor-register">Doctor Register</Link>
                  </li>
                  <li className="has-submenu">
              ...
              <li className="has-submenu">
                ...
                <ul className="submenu">
                  ...
                  <li>
                    <Link to="/mentee/mentor-profile">Doctor Profile</Link>
                  </li>
                  <li className="has-submenu">
                    <Link to="#">Booking</Link>
                    <ul className="submenu inner-submenu">
                      <li>
                        <Link to="/mentee/booking1">Booking 1</Link>
                      </li>
                      <li>
                        <Link to="/mentee/booking2">Booking 2</Link>
                      </li>
                    </ul>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to="/mentee/dashboard">Patient Dashboard</Link>
                  </li>
                  <li>
