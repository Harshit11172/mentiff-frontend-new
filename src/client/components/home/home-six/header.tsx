...
const HomeSixHeader = () => {
  ...
  return (
    <div>
        <>
  {/* Header */}
  <header className="header header-five header-eight">
        ...
        <div className="container">
          ...
          <ul className="nav header-navbar-rht">
            <li className="nav-item">
              <Link
                className="nav-link header-login sign-eight"
                to="/register"
              >
                Sign up
              </Link>
            ...
            <li className="nav-item">
              <Link className="nav-link log-eight" to="/login">
                Log In
              </Link>
            </li>
          </ul>
