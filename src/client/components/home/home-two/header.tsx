...
const HomeTwoHeader = () => {
  ...
  return (
    <header className="header header-one headertwo">
            ...
            <ul className="nav header-navbar-rht">
              <li className="nav-item">
                <Link className="nav-link header-login" to="/register">
                  <ImageWithBasePath src="assets/img/icon/sign-icon.svg" alt="" /> Sign up
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link headerthree" to="/login">
                  {" "}
                  <ImageWithBasePath src="assets/img/icon/log-icon.svg" alt="" /> Log In
                </Link>
              </li>
            </ul>
          </div>
